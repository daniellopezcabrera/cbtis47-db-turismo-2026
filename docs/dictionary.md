...
**Constraint:** origin_id must be different from dest_id.
...
**Constraint:**
- UNIQUE (id_trolley, departure_time) to prevent double scheduling.

---

# Integrity Rules Applied

- Entity Integrity (Primary Keys defined in all tables)
- Referential Integrity (Foreign Keys properly defined)
- Domain Integrity (CHECK, UNIQUE, NOT NULL constraints)
- Monetary precision using DECIMAL instead of FLOAT
- Controlled status values
- Unique identifiers for email, QR code, plate number, and route name
